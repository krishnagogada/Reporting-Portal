...
export const defaultView = () => <NoDataViewContainer style={{backgroundColor:color(colorLabel, defaultValueOfColor)}} 
                                className={array(tailwindStylesLabel,defaultValueOfTailwindStyle,separator)}>
        <NoDataViewText>{text('Not found message', 'No Data Found!')}</NoDataViewText>
      </NoDataViewContainer>
