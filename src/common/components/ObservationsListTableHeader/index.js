...
class ObservationsListTableHeader extends React.Component {
    renderTableHeadings = () => {
        ...
        return tableHeadings.map((eachHeading) => {
            ...
            return <TableHeading data-testid={eachHeading} key={Math.random()}><HeadingWithDropDown onClick={onClickDueDate}><Heading>{eachHeading}</Heading><Image source='https://cdn.zeplin.io/5d0afc9102b7fa56760995cc/assets/8858d716-3b90-491d-a04d-28f1dae3fe1e.svg' 
