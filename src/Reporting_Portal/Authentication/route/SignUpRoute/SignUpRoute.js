...
class SignUpRoute extends React.Component {
    ...
    render() {
        return (<SignUp userName={this.userName} password={this.password} onChangeUserName={this.onChangeUserName}
                        onChangePassword={this.onChangePassword} onChangeComfirmPassword={this.comfirmPassword} 
                        onClickLogIn={this.onClickLogIn} userNameErrorMessage={this.userNameErrorMessage}
                        passwordErrorMessage={this.passwordErrorMessage} comfirmPasswordErrorMessage={this.comfirmPasswordErrorMessage}
