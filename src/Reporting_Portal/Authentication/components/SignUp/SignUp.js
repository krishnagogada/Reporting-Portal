...
import './signUp.css';
import { SignUpForm, SignUpContainer, SignUpHeading } from './styledComponent.js';
        ...
        return (
            <SignUpContainer>
                <SignUpForm>
                    ...
                    <PasswordFieldWithPasswordStrength  value={password} onChangeInputField={onChangePassword}/>
                    <InputFieldWithLabelAndErrorMessage labelName={strings.comfirmPassword} value={comfirmPassword} 
                                                        onChangeInputField={onChangeComfirmPassword} type={strings.passwordType} errorMessage={comfirmPasswordErrorMessage}/>
                    <PrimaryButton className={'sign-up-button'} onClickButton={onClickLogIn}>{strings.logIn}</PrimaryButton>
                </SignUpForm>
            </SignUpContainer>
        );
    }
